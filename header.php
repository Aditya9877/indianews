...
<html lang="en">
    <head>
        ...
        <link href="<?php echo ADMIN_BASE_URL ?>assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link href="<?php echo ADMIN_BASE_URL ?>assets/plugins/font-awesome/css/all.min.css" rel="stylesheet">

      
        <!-- Theme Styles -->
        <link href="<?php echo ADMIN_BASE_URL ?>assets/css/connect.min.css" rel="stylesheet">
        <link href="<?php echo ADMIN_BASE_URL ?>assets/css/dark_theme.css" rel="stylesheet">
        <link href="<?php echo ADMIN_BASE_URL ?>assets/css/custom.css" rel="stylesheet">
            ...
            <div class="page-sidebar">
                ...
                <div class="page-sidebar-inner slimscroll">
                    <ul class="accordion-menu">
                        ...
                        <li>
                            <a href="#"><i class="material-icons-outlined">account_circle</i>Users<i class="material-icons has-sub-menu">add</i></a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="new-users.php">New users</a>
                                </li>
                                <li>
                                    <a href="approved-users.php">Approved users</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="material-icons-outlined">account_circle</i>Post category<i class="material-icons has-sub-menu">add</i></a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="parent-category.php">Parent category</a>
                                </li>
                                <li>
                                    <a href="child-category.php">Sub category</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="material-icons-outlined">account_circle</i>Posts<i class="material-icons has-sub-menu">add</i></a>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item nav-profile dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="<?php echo ADMIN_BASE_URL ?>assets/images/avatars/profile-image-1.png" alt="profile image">
                                    <span><?= isset($_SESSION['admin_name'])?$_SESSION['admin_name']:'' ?></span><i class="material-icons dropdown-icon">keyboard_arrow_down</i>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?= ADMIN_BASE_URL ?>log-out.php">Log out</a>
